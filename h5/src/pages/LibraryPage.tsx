...
type DraftCard = { id: string; title: string; editedAt: string; description: string; cover: string; imageCount: number; videoCount: number; offset: number; isLocal: boolean; runId: string | null; actionLabel: '查看草稿' | '继续创作'; source?: LibraryWork }
...
const activeGenerationStatuses = new Set(['QUEUED', 'ANALYZING_MATERIALS', 'RETRIEVING_KNOWLEDGE', 'GENERATING'])
